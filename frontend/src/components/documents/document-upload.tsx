...
export function DocumentUpload({
  ...
  const validateFile = (file: File): FileValidationResult => {
    ...
    if (!acceptedFileTypes.includes(extension)) {
      errors.push(`Unsupported file type. Supported types: ${acceptedFileTypes.join(', ')}`);
    }
  ...
  const canSubmit = selectedFile && displayName.trim() && validation?.isValid && !loading;
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>
              Upload JSON, PDF, or Markdown files containing game rules and content
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
              ...
              {selectedFile ? (
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Supports: JSON, PDF, Markdown (max {formatFileSize(maxFileSize)})
                    </p>
                  </div>
            ...
            {/* Tags */}
            <div>
              <label htmlFor="tagInput" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                Tags (Optional)
              </label>
              <div className="mt-2">
