...
export function DocumentList({
  ...
  const [typeFilter, setTypeFilter] = useState<'all' | 'JSON' | 'PDF' | 'MARKDOWN'>('all');
  ...
  const filteredDocuments = documents.filter(document => {
    ...
    const matchesValidation = 
      ...
      (validationFilter === 'valid' && document.validationErrors.length === 0) ||
    ...
    return (
      <div className="col-span-full flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="text-muted-foreground max-w-md mb-6">
          Start building your game system by uploading JSON rules, PDF manuals, or Markdown documentation.
        </p>
    ...
    <div className="space-y-6">
      ...
      {!loading && documents.length > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">{stats.markdown}</div>
