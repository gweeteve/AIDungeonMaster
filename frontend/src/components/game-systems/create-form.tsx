...
interface CreateGameSystemFormProps {
...
export function CreateGameSystemForm({
  onSubmit,
  onCancel,
  parentSystem,
  loading = false,
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    const submitData: CreateGameSystemRequest = {
      ...
      <Card>
        <form onSubmit={handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>
              Configure the basic information for your game system
            </CardDescription>
          </CardHeader>
